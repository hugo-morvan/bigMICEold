impute_with_linear_regression <- function(sc, sdf, target_col, feature_cols) {
...
#Call the imputer
imputed_missing_height <- impute_with_linear_regression(sc, df_missing_height, label_col, features_col)
